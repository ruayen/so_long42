...
{
	if (game->map[game->imag->player->instances->y / 32 - 1]
		[game->imag->player->instances->x / 32] != MAP_WALL)
	{
...
{
	if (game->map[game->imag->player->instances->y / 32]
		[game->imag->player->instances->x / 32 - 1] != MAP_WALL)
	{
